...
inline U64 allOne(U64 b) {
  return soutOne(b) | nortOne(b) | eastOne(b) | westOne(b) | soEaOne(b) |
         soWeOne(b) | noEaOne(b) | noWeOne(b);
}
...
inline U64 soutAttacks(U64 rooks, U64 empty) {
  return soutOne(soutOccl(rooks, empty));
}
inline U64 nortAttacks(U64 rooks, U64 empty) {
  return nortOne(nortOccl(rooks, empty));
}
inline U64 eastAttacks(U64 rooks, U64 empty) {
  return eastOne(eastOccl(rooks, empty));
}
inline U64 noEaAttacks(U64 bishops, U64 empty) {
  return noEaOne(noEaOccl(bishops, empty));
}
inline U64 soEaAttacks(U64 bishops, U64 empty) {
  return soEaOne(soEaOccl(bishops, empty));
}
inline U64 westAttacks(U64 rooks, U64 empty) {
  return westOne(westOccl(rooks, empty));
}
inline U64 soWeAttacks(U64 bishops, U64 empty) {
  return soWeOne(soWeOccl(bishops, empty));
}
inline U64 noWeAttacks(U64 bishops, U64 empty) {
  return noWeOne(noWeOccl(bishops, empty));
}
